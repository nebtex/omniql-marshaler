...
func (e *Encoder) encodeUnion(path string, out map[string]interface{}, fieldName string, ot oreflection.OType, fn hybrids.FieldNumber, tr hybrids.TableReader) (err error) {
	var itemOt oreflection.OType
	var ok bool
	var enumName string
	fieldValue := map[string]interface{}{}

	kind, table, ok, err := tr.Union(fn)
	if err != nil {
		err = &EncoderError{
			Path:        path,
	...
	fieldValue[enumName] = map[string]interface{}{}
